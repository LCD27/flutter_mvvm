...
//
//   ///搜索 get
//   static search(q, sort, order, type, pages, [pageSize = Config.PAGE_SIZE]) {
//     if (type == 'user') {
//       return "${host}search/users?q=$q&pages=$pages&per_page=$pageSize";
//     }
//     sort ??= "best%20match";
//     order ??= "desc";
//     pages ??= 1;
//     pageSize ??= Config.PAGE_SIZE;
//     return "${host}search/repositories?q=$q&sort=$sort&order=$order&pages=$pages&per_page=$pageSize";
//   }
//
//   ///搜索topic tag
...
//
//   ///处理分页参数
//   static getPageParams(tab, pages, [pageSize = Config.PAGE_SIZE]) {
//     if (pages != null) {
//       if (pageSize != null) {
//         return "${tab}pages=$pages&per_page=$pageSize";
//       } else {
//         return "${tab}pages=$pages";
//       }
//     } else {
//       return "";
//     }
